...
<div id="maincol">
<c:choose>	
	<c:when test="${empty person.id}"><h2>Lis‰‰ uusi k‰ytt‰j‰</h2></c:when>
...
<table border="0" width="400px">
	...
	<tr>
		<td width="17%" align="right">Teht‰v‰nimike:</td>
		<td width="33%" align="left">
	...
	<tr>
		...
		<td align="left" colspan="3">
			<form:radiobutton path="roleCode" value="W"/>Ty√∂ntekij√§ 
			<form:radiobutton path="roleCode" value="M"/>Manager 
			<form:radiobutton path="roleCode" value="S"/>P√§√§k√§ytt√§j√§ 
		</td>		
	</tr>
	<tr>
